...
/**/;(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[453],{727:(e,t,r)=>{"use strict";r.r(t),r.d(t,{default:()=>i});var s=r(9625);(0,s.g)();var n=r(8800),o=n.middleware||n.default;if("function"!=typeof o)throw Error('The Edge Function "pages/api/hello" must export a `default` function');function i(e){return(0,s.V)({...e,page:"/api/hello",handler:o})}},8800:(e,t,r)=>{"use strict";function s(e,t){t.status(200).json({name:"John Doe"})}r.r(t),r.d(t,{default:()=>s})},9625:(e,t,r)=>{"use strict";r.d(t,{V:()=>ee,g:()=>es});class s extends Error{constructor({page:e}){super(`The middleware "${e}" accepts an async API directly with the form:
